function [label, center, bCon, sumD, D] = litekmeans(X, k, varargin)
    ...
    pnames = {'distance','start','maxiter','replicates','onlinephase','clustermaxiter','scale'};
    dflts = {'sqeuclidean','sample',[],[],'off',[]};
    [eid, errmsg, distance, start, maxit, reps, online, clustermaxit, scale] = getargs(pnames, dflts, varargin{:});
    ...
    for t = 1:reps
        ...
        switch start
            ...
            case 'cluster'
                ...
                [dump, center] = litekmeans(Xsubset, k, varargin{:}, ...
