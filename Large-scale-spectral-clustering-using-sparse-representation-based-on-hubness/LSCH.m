function label = LSCH(data, k, opts)
    ...
    %
    %   Modified by Hongmin Li (li.hongmin.xa@alumni.tsukuba.ac.jp)
    ...
    elseif strcmp(mode, 'random')
        ...
        clear indSmp
    elseif strcmp(mode, 'khubs')
        hubsNumPart = 10;
        hubsNumR = r;
        kmMaxIter = 5;
        kmNumRep = 1;
        marks = localhubs(data, p, hubsNumPart, 'kmeans', hubsNumR, ...
            'MaxIter', kmMaxIter, 'Replicates', kmNumRep);
    elseif strcmp(mode, 'rhubs')
        hubsNumPart = 10;
        hubsNumR = r;
        marks = localhubs(data, p, hubsNumPart, 'random', hubsNumR);
    else
